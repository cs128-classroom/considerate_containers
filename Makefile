...
bin/exec: ./includes/node.hpp ./includes/container.hpp ./includes/GraphAdjList.hpp ./includes/queue.hpp ./includes/stack.hpp ./includes/solution.hpp ./src/solution.cc ./src/driver.cc
	$(CXX) $(CXXFLAGS) ./src/driver.cc ./src/solution.cc   -o $@

bin/tests: ./includes/node.hpp ./includes/container.hpp ./includes/GraphAdjList.hpp ./includes/queue.hpp ./includes/stack.hpp ./includes/solution.hpp ./src/solution.cc ./tests/tests.cc 
